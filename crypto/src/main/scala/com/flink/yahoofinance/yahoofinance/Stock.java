package com.flink.yahoofinance.yahoofinance;
...
public class Stock {
     ...
     * @see         #getHistory(Calendar, yahoofinance.histquotes.Interval)
     * @see         #getHistory(Calendar, Calendar, yahoofinance.histquotes.Interval)
     */
